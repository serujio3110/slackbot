...
def test_run_at_times(driver):
    driver.send_channel_message('start run at times test')
    driver.wait_for_bot_channel_message('Run at times function works!', tosender=False)
